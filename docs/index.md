...
I have 13 years of experience, and I'm currently working at **Google** as a senior software engineer SRE on the ML Compute team. Previously, I was a software engineer at Docker, maintaining systems like Docker registry, Hub, and search; a staff engineer at Beat, a Uber competitor, designing and operating critical services focused on reliability and observability; led the transformation of the notification platform into scalable microservices at Utility Warehouse, achieving a 90%+ latency reduction; at SkySoft-ATM, I worked in a safety-critical environment in the context of the Swiss air navigation service provider, where I designed, proposed, and implemented the company's central data repository used to store and compute flight events; and served as a tech lead and architect at Axa and Airbus Helicopters.

In 2022, I authored [**_100 Go Mistakes and How to Avoid Them_**](book.md), a well-received book (4.7/5 avg rating on Amazon, Goodreads, and Manning) that has sold over 10,000 copies globally and been translated into five languages. Additionally, in 2024 I launched [**_The Coder Cafe_**](https://thecoder.cafe/?rd=teivah.dev), a newsletter tailored for software engineers.
